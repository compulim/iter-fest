...
- 👷🏻 Test framework moved from Jest to Node.js test runner, by [@compulim](https://github.com/compulim) in PR [#81](https://github.com/compulim/iter-festo/pull/81)

## [0.3.1] - 2025-12-22

### Changed

- Bumped dependencies, in PR [#78](https://github.com/compulim/iter-fest/pull/78)
...
[Unreleased]: https://github.com/compulim/iter-fest/compare/v0.3.1...HEAD
[0.3.1]: https://github.com/compulim/iter-fest/compare/v0.3.0...v0.3.1
