...
- Added `iteratorDrop`, `iteratorFlatMap`, `iteratorFrom`, `iteratorTake`, `iteratorToArray` in PR [#XXX](https://github.com/compulim/iter-fest/pull/XXX)

### Changed

- Following functions will be using ponyfill from `core-js-pure` with types, in PR [#XXX](https://github.com/compulim/iter-fest/pull/XXX)
