...
export default defineConfig([
  {
    ...
    entry: {
      ...
      'iterable-fest.iterableEntries': './src/iterableEntries.ts',
      ...
      'iterable-fest.iterableForEach': './src/iterableForEach.ts',
      ...
      'iterable-fest.iterableKeys': './src/iterableKeys.ts',
      'iterable-fest.iterableMap': './src/iterableMap.ts',
      ...
      'iterable-fest.iteratorToIterable': './src/iteratorToIterable.ts'
    },
    format: ['cjs', 'esm'],
    sourcemap: true
  }
